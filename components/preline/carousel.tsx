// export const CarouselPrelineMultipleSlides = () => {
...
//             <span className="self-center text-sm text-gray-800 transition duration-700 dark:text-white">First slide</span>
//           </div>
//         </div>
//         <div className="hs-carousel-slide px-1">
//           <div className="flex justify-center h-full bg-gray-200 p-6 dark:bg-neutral-800">
//             <span className="self-center text-sm text-gray-800 transition duration-700 dark:text-white">Second slide</span>
//           </div>
//         </div>
//         <div className="hs-carousel-slide px-1">
//           <div className="flex justify-center h-full bg-gray-300 p-6 dark:bg-neutral-700">
//             <span className="self-center text-sm text-gray-800 transition duration-700 dark:text-white">Third slide</span>
//           </div>
//         </div>
//         <div className="hs-carousel-slide px-1">
//           <div className="flex justify-center h-full bg-gray-100 p-6 dark:bg-neutral-900">
//             <span className="self-center text-sm text-gray-800 transition duration-700 dark:text-white">Fourth slide</span>
//           </div>
//         </div>
//         <div className="hs-carousel-slide px-1">
//           <div className="flex justify-center h-full bg-gray-200 p-6 dark:bg-neutral-800">
//             <span className="self-center text-sm text-gray-800 transition duration-700 dark:text-white">Fifth slide</span>
//           </div>
//         </div>
//         <div className="hs-carousel-slide px-1">
//           <div className="flex justify-center h-full bg-gray-300 p-6 dark:bg-neutral-700">
//             <span className="self-center text-sm text-gray-800 transition duration-700 dark:text-white">Sixth slide</span>
//           </div>
//         </div>
//       </div>
//     </div>
