...
import Hero, { HeroWaves } from "@/components/hero";
...
export default function ComingSoonPage() {
  const features1: Feature[] = [
    ...
    {
      title: "Connect",
      description: `["Don't say that, Ananda. Don't say that. Admirable friendship, admirable companionship, admirable camaraderie is actually the whole of the holy life. "]`,
  ...
  return (
    <>
      ...
      <FeaturesGrid
        features={features1}
        header="Coming Soon"
        subHeader="A meditation center in the heart of NYC."
      />
